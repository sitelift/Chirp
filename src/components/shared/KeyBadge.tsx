...
export function KeyBadge({ keyLabel, variant = 'default' }: KeyBadgeProps) {
  const styles = variant === 'glass'
    ...
    : 'inline-flex min-w-[28px] items-center justify-center rounded-md border border-card-border bg-dm-keybadge-bg px-2 py-0.5 font-mono text-xs font-medium text-dm-keybadge-text shadow-[0_1px_2px_rgba(0,0,0,0.04)]'
  return (
